...
from .views import (IndexView, ResourceView, UploadView, DownloadView, DetailView, MessageView, AboutView, DonateView, ExchangeView, ProjectView, QuestionView, MySearchView, LoveView, LinkView)
...
urlpatterns = [
    ...
    url(r'^category/resource//$',ResourceView.as_view(),name='resource'),
    url(r'^resource/upload/$', UploadView, name='upload'),
    url(r'^resource/download/(?P<resource_id>\d+)/$',DownloadView,name='download'),
    # 分类页面
